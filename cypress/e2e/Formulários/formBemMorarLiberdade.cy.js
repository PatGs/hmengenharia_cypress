...
describe('Testar a página do empreendimento HM Bem Morar Liberdade', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-bem-morar-liberdade');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Chegou a hora de morar bem no HM Bem Morar Novo Liberdade');
    });
});
