...
describe('Testar a página do empreendimento HM Residencial Joias de Santa Bárbara - Esmeralda', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-residencial-joias-de-santa-barbara-esmeralda');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Viva o melhor da vida no Residencial Esmeralda');
    });
});
