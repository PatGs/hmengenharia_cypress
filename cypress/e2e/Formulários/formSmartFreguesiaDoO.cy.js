...
describe('Testar a página do empreendimento HM Smart Freguesia Do Ó', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-smart-freguesia-do-o');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Viva o melhor no HM Smart Freguesia do Ó');
    });
});
