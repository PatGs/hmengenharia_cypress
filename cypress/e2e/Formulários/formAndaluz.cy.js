...
describe('Testar a página do empreendimento HM Andaluz', () => {
    const usuario = {
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'No HM Andaluz você constrói a casa dos seus sonhos.');
    });
});
