...
describe('Testar a página do empreendimento HM Reserva dos Ibirás', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-reserva-dos-ibiras');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Construa a casa dos seus sonhos em HM Reserva dos Ibirás');
    });
});
