...
describe('Testar a página do empreendimento HM Smart Bem Morar São Jorge', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-smart-bem-morar-sao-jorge');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Viva o jeito inteligente do HM Smart Bem Morar São Jorge');
    });
});
