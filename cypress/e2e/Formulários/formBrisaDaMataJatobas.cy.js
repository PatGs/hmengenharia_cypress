...
describe('Testar a página do empreendimento HM Brisa da Mata Jatobás', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-brisa-da-mata-jatobas');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Viva uma vida completa em HM Brisa da Mata Jatobás');
    });
});
