...
describe('Testar a página do empreendimento HM Smart Guaianases', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-smart-guaianases');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'UM LAR INTELIGENTE PARA CHAMAR DE SEU. CONHEÇA O HM SMART GUAIANASES. ');
    });
});
