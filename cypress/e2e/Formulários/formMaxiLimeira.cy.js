...
describe('Testar a página do empreendimento HM Maxi Limeira', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-maxi-limeira');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Descubra o lado Maxi de viver o melhor da vida em HM Maxi Limeira');
    });
});
})
