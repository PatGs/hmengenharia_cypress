...
describe('Testar a página do empreendimento HM Brisa da Mata Araucária', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-brisa-da-mata-araucaria');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Viva com muito conforto em HM Brisa da Mata Araucária');
    });
});
