...
describe('Testar a página do empreendimento HM Brisa da Mata Vilage', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-brisa-da-mata-vilage');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'A casa dos seus sonhos está em HM Brisa da Mata Vilage');
    });
});
