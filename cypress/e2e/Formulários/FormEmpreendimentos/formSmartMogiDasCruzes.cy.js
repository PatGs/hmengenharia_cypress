...
describe('Testar a página do empreendimento HM Smart Mogi das Cruzes', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-smart-mogi-das-cruzes');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Viva com lazer para toda a família no HM Smart Mogi das Cruzes');
    });
});
})
