...
describe('Testar a página do empreendimento HM Smart Hortolândia', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-smart-hortolandia');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Seu próximo apê com lazer completo e piscina no HM Smart Hortolândia');
    });
});
