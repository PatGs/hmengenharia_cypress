...
describe('Testar a página do empreendimento HM Vila dos Ibirás Residencial', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-vila-dos-ibiras-residencial');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Viva com tranquilidade e conforto no HM Vila dos Ibirás Residencial');
    });
});
