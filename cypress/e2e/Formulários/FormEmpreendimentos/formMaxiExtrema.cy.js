...
describe('Testar a página do empreendimento HM Maxi Extrema', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-maxi-extrema');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Viva em HM Maxi Extrema, um projeto que combina com você em máximos detalhes.');
    });
});
