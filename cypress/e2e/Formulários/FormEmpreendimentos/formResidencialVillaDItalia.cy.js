...
describe('Testar a página do empreendimento HM Residencial Ville D Itália - Villa Bergamo', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-residencial-villa-bergamo');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Viva com conforto em Villa Bergamo Residencial');
    });
});
