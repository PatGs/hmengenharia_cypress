...
describe('Testar a página do empreendimento HM Smart Paulínia', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-smart-paulinia');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'HM Smart Paulínia é uma escolha inteligente. Como seu primeiro apê deve ser.');
    });
});
