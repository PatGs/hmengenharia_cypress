...
describe('Testar a página do empreendimento HM Smart São Carlos', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-smart-sao-carlos');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Conheça seu próximo apê no HM Smart São Carlos com lazer e perto de tudo!');
    });
});
