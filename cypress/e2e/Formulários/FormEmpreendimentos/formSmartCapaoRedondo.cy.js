...
describe('Testar a página do empreendimento HM Smart Capão Redondo', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-smart-capao-redondo');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Seu próximo apê com 2 dormitórios no HM Smart Capão Redondo');
    });
});
})
