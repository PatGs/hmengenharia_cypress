...
describe('Testar a página do empreendimento HM Maxi Campinas', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-maxi-campinas');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Você é Maxi. Viva em um lugar que também é. Conheça HM Maxi Campinas. ');
    });
});
})
