...
describe('Testar a página do empreendimento HM Vanguard Maxi', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-vanguard-maxi');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'CONHEÇA HM VANGUARD MAXI. UM PROJETO QUE COMBINA COM VOCÊ NOS MÁXIMOS DETALHES.');
    });
});
