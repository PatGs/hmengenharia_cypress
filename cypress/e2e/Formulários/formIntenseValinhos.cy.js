...
describe('Testar a página do empreendimento HM Intense Valinhos', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-intense-valinhos');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'VIVA DO SEU JEITO NO HM INTENSE VALINHOS');
    });
});
