...
describe('Testar a página do empreendimento HM Harmonia Morumbi', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-harmonia-morumbi');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Escolha viver com conforto e qualidade de vida em HM Harmonia Morumbi Residence');
    });
});
