...
describe('Testar a página do empreendimento HM Brisa da Mata Manacás', () => {
    const usuario = {
      ...
      it('Deve realizar o envio do Formulário corretamente.', () => {
        cy.visit('/imoveis/hm-brisa-da-mata-manacas');
...
context('Interceptando solicitações de rede', () => {
    ...
    it('Deve fazer a interceptação do POST ao realizar o input do Formulário', () => {
        ...
        cy.get('h1')
          .should('contain.text', 'Viva com lazer completo em HM Brisa da Mata Manacás');
    });
});
